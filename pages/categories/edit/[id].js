    ...
    return (
        <>
            <div
                ...
                <h4 className="fw-bold">  Edit category: {category.name}</h4>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="row gy-4">
                <div className="col-md-3">
                    <label className="form-label">Name</label>
                    <input {...register("name", { required: 'The name field is required.   ' })} defaultValue={category.name} type="text" className="form-control" />
