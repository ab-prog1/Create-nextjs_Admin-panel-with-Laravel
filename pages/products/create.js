...
import persian from "react-date-object/calendars/gregorian"
import persian_fa from "react-date-object/locales/gregorian_en"
...
const CreateProduct = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            toast.success(' The desired product was created successfully.')
    ...
    return (
        <>
            <div
                ...
                <h4 className="fw-bold">Create a product </h4>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="row gy-4">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            ...
                            {primaryImage ? (
                                ...
                                <>
                                    <input {...register("primary_image", { required: 'The main image field is required. ' })} type="file" className="form-control" />
                ...
                <div className="col-md-3">
                    ...
                    <input {...register("images", { required: ' The image field is required.' })} type="file" multiple className="form-control" />
                ...
                <div className="col-md-3">
                    ...
                    <select {...register("category_id", { required: ' The category field is required.' })} defaultValue="" className="form-control">
                ...
                <div className="col-md-3">
                    ...
                    <select {...register("status", { required: 'The status field is required.' })} defaultValue="1" className="form-control">
                ...
                <div className="col-md-3">
                    ...
                    <input {...register("price", { required: ' The price field is required.' })} type="text" className="form-control" />
                    <div className="form-text text-danger">{errors.price?.message}</div>
                </div>
                <div className="col-md-3">
                    <label className="form-label">Quantity</label>
                    <input {...register("quantity", { required: 'Number field is required.' })} type="text" className="form-control" />
                    <div className="form-text text-danger">{errors.quantity?.message}</div>
                </div>
                <div className="col-md-3">
                    <label className="form-label">blurDataURL Primary Image</label>
                    <input {...register("primary_image_blurDataURL", { required: 'The blurDataURL field is required.' })} type="text" className="form-control" />
                ...
                <div className="col-md-4">
                    <label className="form-label">Auction start and end date</label>
                    <DatePicker
                ...
                <div className="col-md-12">
                    ...
                    <textarea rows="5" {...register("description", { required: 'The description field is required.' })} className="form-control"></textarea>
