        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="row gy-4">
                ...
                <div className="col-md-3">
                    ...
                    <input {...register("name", { required: '   The name field is required.' })} defaultValue={product.name} type="text" className="form-control" />
                    <div className="form-text text-danger">{errors.name?.message}</div>
                </div>
                <div className="col-md-3">
                    <label className="form-label">Category </label>
                    <select {...register("category_id", { required: 'The category field is required.' })} defaultValue={product.category_id} className="form-control">
                ...
                <div className="col-md-3">
                    ...
                    <select {...register("status", { required: 'The status field is required.   ' })} defaultValue={product.status_value} className="form-control">
                ...
                <div className="col-md-3">
                    ...
                    <input {...register("price", { required: '   The price field is required.' })} defaultValue={product.price} type="text" className="form-control" />
                    <div className="form-text text-danger">{errors.price?.message}</div>
                </div>
                <div className="col-md-3">
                    <label className="form-label">Quantity</label>
                    <input {...register("quantity", { required: 'Number field is required.' })} defaultValue={product.quantity} type="text" className="form-control" />
                    <div className="form-text text-danger">{errors.quantity?.message}</div>
                </div>
                <div className="col-md-3">
                    <label className="form-label">primary image blurDataURL</label>
                    <input {...register("primary_image_blurDataURL", { required: 'The blurDataURL field is required.   ' })} defaultValue={product.primary_image_blurDataURL} type="text" className="form-control" />
                ...
                <div className="col-md-12">
                    ...
                    <textarea rows="5" {...register("description", { required: '   The description field is required.' })} defaultValue={product.description} className="form-control"></textarea>
